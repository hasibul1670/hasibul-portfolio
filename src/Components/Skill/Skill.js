  ...
  return (
    <div id="skill" className="container">
      ...
      <div class="card-deck">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-center text text-white">
                Top 10 Things For Beginners About JavaScript
              </h5>
              ...
              <div className="text-center">
                <a
                  href="https://hasibulislam1670.medium.com/top-10-things-for-beginners-about-javascript-38a3946cc610"
                  class="btn1 btn  Skill-btn "
                >
                  Read
                </a>
              </div>
        ...
        <div className="col-9 col-sm-9 col-md-6 col-lg-6 col-xl-4">
          <div class="card">
            <img className="      img-fluid card-img-top" alt="..." />
            <div class="card-body">
              <h5 class="card-title text-center text text-white">
                Let’s Start a Journey With React
              </h5>
              <p class="card-text text-center text-white ">
              ...
              <div className="text-center">
                <a
                  href="https://hasibulislam1670.medium.com/lets-start-a-journey-with-react-7bac7e5093d0"
                  class="btn1 btn Skill-btn "
                >
                  Read
                </a>
